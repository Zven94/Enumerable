...
- Use [my_enumarable.rb](./my_enumarable.rb) it contains a module with 3 methods to itarete an array.
- Use [MyList.yml](./MyList.yml) it contains the MyList class with a 2 method, one for iterate it self and print its own values and another one to add new values to the @list.
- Use [main.rb](./main.rb) it contains the codes to run and test the class MyList with the my_enumerable methods
